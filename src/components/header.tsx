  ...
  return (
    <header>
      ...
      <div
        ...
        aria-label="Global"
      >
        <div className="group relative ml-8 flex items-center lg:-ml-4">
          <Nav />
        </div>

        <div className="flex gap-x-4">
          <div className="hidden rounded-md  bg-neutral-900 p-1 px-5 lg:flex">
            <a
              href="#"
          ...
          <div className="hidden rounded-md  bg-white p-1 px-5  lg:flex">
            <a
              href="#"
              className="text-sm font-semibold leading-6 text-[#03000A]"
            >
              Request access
            </a>
          </div>
